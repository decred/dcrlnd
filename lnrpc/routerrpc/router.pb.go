...
var file_routerrpc_router_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x61, 0x67, 0x65, 0x2a, 0x81, 0x04, 0x0a, 0x0d, 0x46, 0x61, 0x69, 0x6c, 0x75, 0x72,
	...
	0x52, 0x45, 0x53, 0x55, 0x4d, 0x45, 0x10, 0x02, 0x32, 0xa8, 0x0a, 0x0a, 0x06, 0x52, 0x6f, 0x75,
...
var file_routerrpc_router_proto_msgTypes = make([]protoimpl.MessageInfo, 34)
var file_routerrpc_router_proto_goTypes = []interface{}{
	...
	(*GetMissionControlConfigRequest)(nil),  // 16: routerrpc.GetMissionControlConfigRequest
	(*GetMissionControlConfigResponse)(nil), // 17: routerrpc.GetMissionControlConfigResponse
	(*SetMissionControlConfigRequest)(nil),  // 18: routerrpc.SetMissionControlConfigRequest
	(*SetMissionControlConfigResponse)(nil), // 19: routerrpc.SetMissionControlConfigResponse
	(*MissionControlConfig)(nil),            // 20: routerrpc.MissionControlConfig
	(*QueryProbabilityRequest)(nil),         // 21: routerrpc.QueryProbabilityRequest
	(*QueryProbabilityResponse)(nil),        // 22: routerrpc.QueryProbabilityResponse
	(*BuildRouteRequest)(nil),               // 23: routerrpc.BuildRouteRequest
	(*BuildRouteResponse)(nil),              // 24: routerrpc.BuildRouteResponse
	(*SubscribeHtlcEventsRequest)(nil),      // 25: routerrpc.SubscribeHtlcEventsRequest
	(*HtlcEvent)(nil),                       // 26: routerrpc.HtlcEvent
	(*HtlcInfo)(nil),                        // 27: routerrpc.HtlcInfo
	(*ForwardEvent)(nil),                    // 28: routerrpc.ForwardEvent
	(*ForwardFailEvent)(nil),                // 29: routerrpc.ForwardFailEvent
	(*SettleEvent)(nil),                     // 30: routerrpc.SettleEvent
	(*LinkFailEvent)(nil),                   // 31: routerrpc.LinkFailEvent
	(*PaymentStatus)(nil),                   // 32: routerrpc.PaymentStatus
	(*CircuitKey)(nil),                      // 33: routerrpc.CircuitKey
	(*ForwardHtlcInterceptRequest)(nil),     // 34: routerrpc.ForwardHtlcInterceptRequest
	(*ForwardHtlcInterceptResponse)(nil),    // 35: routerrpc.ForwardHtlcInterceptResponse
	nil,                                     // 36: routerrpc.SendPaymentRequest.DestCustomRecordsEntry
	nil,                                     // 37: routerrpc.ForwardHtlcInterceptRequest.CustomRecordsEntry
	(*lnrpc.RouteHint)(nil),                 // 38: lnrpc.RouteHint
	(lnrpc.FeatureBit)(0),                   // 39: lnrpc.FeatureBit
	(*lnrpc.Route)(nil),                     // 40: lnrpc.Route
	(*lnrpc.Failure)(nil),                   // 41: lnrpc.Failure
	(lnrpc.Failure_FailureCode)(0),          // 42: lnrpc.Failure.FailureCode
	(*lnrpc.HTLCAttempt)(nil),               // 43: lnrpc.HTLCAttempt
	(*lnrpc.Payment)(nil),                   // 44: lnrpc.Payment
}
var file_routerrpc_router_proto_depIdxs = []int32{
	38, // 0: routerrpc.SendPaymentRequest.route_hints:type_name -> lnrpc.RouteHint
	36, // 1: routerrpc.SendPaymentRequest.dest_custom_records:type_name -> routerrpc.SendPaymentRequest.DestCustomRecordsEntry
	39, // 2: routerrpc.SendPaymentRequest.dest_features:type_name -> lnrpc.FeatureBit
	40, // 3: routerrpc.SendToRouteRequest.route:type_name -> lnrpc.Route
	41, // 4: routerrpc.SendToRouteResponse.failure:type_name -> lnrpc.Failure
	...
	20, // 7: routerrpc.GetMissionControlConfigResponse.config:type_name -> routerrpc.MissionControlConfig
	20, // 8: routerrpc.SetMissionControlConfigRequest.config:type_name -> routerrpc.MissionControlConfig
	15, // 9: routerrpc.QueryProbabilityResponse.history:type_name -> routerrpc.PairData
	40, // 10: routerrpc.BuildRouteResponse.route:type_name -> lnrpc.Route
	3,  // 11: routerrpc.HtlcEvent.event_type:type_name -> routerrpc.HtlcEvent.EventType
	28, // 12: routerrpc.HtlcEvent.forward_event:type_name -> routerrpc.ForwardEvent
	29, // 13: routerrpc.HtlcEvent.forward_fail_event:type_name -> routerrpc.ForwardFailEvent
	30, // 14: routerrpc.HtlcEvent.settle_event:type_name -> routerrpc.SettleEvent
	31, // 15: routerrpc.HtlcEvent.link_fail_event:type_name -> routerrpc.LinkFailEvent
	27, // 16: routerrpc.ForwardEvent.info:type_name -> routerrpc.HtlcInfo
	27, // 17: routerrpc.LinkFailEvent.info:type_name -> routerrpc.HtlcInfo
	42, // 18: routerrpc.LinkFailEvent.wire_failure:type_name -> lnrpc.Failure.FailureCode
	...
	43, // 21: routerrpc.PaymentStatus.htlcs:type_name -> lnrpc.HTLCAttempt
	33, // 22: routerrpc.ForwardHtlcInterceptRequest.incoming_circuit_key:type_name -> routerrpc.CircuitKey
	37, // 23: routerrpc.ForwardHtlcInterceptRequest.custom_records:type_name -> routerrpc.ForwardHtlcInterceptRequest.CustomRecordsEntry
	33, // 24: routerrpc.ForwardHtlcInterceptResponse.incoming_circuit_key:type_name -> routerrpc.CircuitKey
	2,  // 25: routerrpc.ForwardHtlcInterceptResponse.action:type_name -> routerrpc.ResolveHoldForwardAction
	4,  // 26: routerrpc.Router.SendPaymentV2:input_type -> routerrpc.SendPaymentRequest
	5,  // 27: routerrpc.Router.TrackPaymentV2:input_type -> routerrpc.TrackPaymentRequest
	6,  // 28: routerrpc.Router.EstimateRouteFee:input_type -> routerrpc.RouteFeeRequest
	8,  // 29: routerrpc.Router.SendToRoute:input_type -> routerrpc.SendToRouteRequest
	8,  // 30: routerrpc.Router.SendToRouteV2:input_type -> routerrpc.SendToRouteRequest
	10, // 31: routerrpc.Router.ResetMissionControl:input_type -> routerrpc.ResetMissionControlRequest
	12, // 32: routerrpc.Router.QueryMissionControl:input_type -> routerrpc.QueryMissionControlRequest
	16, // 33: routerrpc.Router.GetMissionControlConfig:input_type -> routerrpc.GetMissionControlConfigRequest
	18, // 34: routerrpc.Router.SetMissionControlConfig:input_type -> routerrpc.SetMissionControlConfigRequest
	21, // 35: routerrpc.Router.QueryProbability:input_type -> routerrpc.QueryProbabilityRequest
	23, // 36: routerrpc.Router.BuildRoute:input_type -> routerrpc.BuildRouteRequest
	25, // 37: routerrpc.Router.SubscribeHtlcEvents:input_type -> routerrpc.SubscribeHtlcEventsRequest
	4,  // 38: routerrpc.Router.SendPayment:input_type -> routerrpc.SendPaymentRequest
	5,  // 39: routerrpc.Router.TrackPayment:input_type -> routerrpc.TrackPaymentRequest
	35, // 40: routerrpc.Router.HtlcInterceptor:input_type -> routerrpc.ForwardHtlcInterceptResponse
	44, // 41: routerrpc.Router.SendPaymentV2:output_type -> lnrpc.Payment
	44, // 42: routerrpc.Router.TrackPaymentV2:output_type -> lnrpc.Payment
	7,  // 43: routerrpc.Router.EstimateRouteFee:output_type -> routerrpc.RouteFeeResponse
	9,  // 44: routerrpc.Router.SendToRoute:output_type -> routerrpc.SendToRouteResponse
	43, // 45: routerrpc.Router.SendToRouteV2:output_type -> lnrpc.HTLCAttempt
	11, // 46: routerrpc.Router.ResetMissionControl:output_type -> routerrpc.ResetMissionControlResponse
	13, // 47: routerrpc.Router.QueryMissionControl:output_type -> routerrpc.QueryMissionControlResponse
	17, // 48: routerrpc.Router.GetMissionControlConfig:output_type -> routerrpc.GetMissionControlConfigResponse
	19, // 49: routerrpc.Router.SetMissionControlConfig:output_type -> routerrpc.SetMissionControlConfigResponse
	22, // 50: routerrpc.Router.QueryProbability:output_type -> routerrpc.QueryProbabilityResponse
	24, // 51: routerrpc.Router.BuildRoute:output_type -> routerrpc.BuildRouteResponse
	26, // 52: routerrpc.Router.SubscribeHtlcEvents:output_type -> routerrpc.HtlcEvent
	32, // 53: routerrpc.Router.SendPayment:output_type -> routerrpc.PaymentStatus
	32, // 54: routerrpc.Router.TrackPayment:output_type -> routerrpc.PaymentStatus
	34, // 55: routerrpc.Router.HtlcInterceptor:output_type -> routerrpc.ForwardHtlcInterceptRequest
