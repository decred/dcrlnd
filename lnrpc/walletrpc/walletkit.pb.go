...
func (x *FundPsbtRequest) GetAtomsPerByte() uint32 {
...
type FundPsbtRequest_AtomsPerByte struct {
	// The fee rate, expressed in atoms/byte, that should be used to spend the
	// input with.
	AtomsPerByte uint32 `protobuf:"varint,4,opt,name=atoms_per_byte,json=atomsPerByte,proto3,oneof"`
}
...
var file_walletrpc_walletkit_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xcb, 0x01, 0x0a, 0x0f,
	...
	0x6f, 0x6e, 0x66, 0x12, 0x26, 0x0a, 0x0e, 0x61, 0x74, 0x6f, 0x6d, 0x73, 0x5f, 0x70, 0x65, 0x72,
	0x5f, 0x62, 0x79, 0x74, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x48, 0x01, 0x52, 0x0c, 0x61,
	0x74, 0x6f, 0x6d, 0x73, 0x50, 0x65, 0x72, 0x42, 0x79, 0x74, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x61,
	0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x63,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x0a, 0x0a, 0x08, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x68, 0x0a, 0x09, 0x55, 0x74,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0x36, 0x0a, 0x13, 0x46, 0x69, 0x6e, 0x61, 0x6c, 0x69, 0x7a, 0x65,
	...
	0x52, 0x0a, 0x66, 0x75, 0x6e, 0x64, 0x65, 0x64, 0x50, 0x73, 0x62, 0x74, 0x22, 0x59, 0x0a, 0x14,
	...
	0x46, 0x69, 0x6e, 0x61, 0x6c, 0x54, 0x78, 0x2a, 0x7a, 0x0a, 0x0b, 0x41, 0x64, 0x64, 0x72, 0x65,
	...
	0x01, 0x32, 0x90, 0x0e, 0x0a, 0x09, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x4b, 0x69, 0x74, 0x12,
...
var file_walletrpc_walletkit_proto_msgTypes = make([]protoimpl.MessageInfo, 51)
var file_walletrpc_walletkit_proto_goTypes = []interface{}{
	...
	(*SpendUTXOsRequest_UTXOAndKey)(nil),      // 50: walletrpc.SpendUTXOsRequest.UTXOAndKey
	(*SpendUTXOsRequest_Output)(nil),          // 51: walletrpc.SpendUTXOsRequest.Output
	nil,                                       // 52: walletrpc.TxTemplate.OutputsEntry
	(*lnrpc.Utxo)(nil),                        // 53: lnrpc.Utxo
	(*lnrpc.OutPoint)(nil),                    // 54: lnrpc.OutPoint
	(*signrpc.TxOut)(nil),                     // 55: signrpc.TxOut
	(*lnrpc.TransactionDetails)(nil),          // 56: lnrpc.TransactionDetails
	(*signrpc.KeyLocator)(nil),                // 57: signrpc.KeyLocator
	(*signrpc.KeyDescriptor)(nil),             // 58: signrpc.KeyDescriptor
}
var file_walletrpc_walletkit_proto_depIdxs = []int32{
	53, // 0: walletrpc.ListUnspentResponse.utxos:type_name -> lnrpc.Utxo
	54, // 1: walletrpc.LeaseOutputRequest.outpoint:type_name -> lnrpc.OutPoint
	54, // 2: walletrpc.ReleaseOutputRequest.outpoint:type_name -> lnrpc.OutPoint
	...
	55, // 8: walletrpc.SendOutputsRequest.outputs:type_name -> signrpc.TxOut
	54, // 9: walletrpc.PendingSweep.outpoint:type_name -> lnrpc.OutPoint
	...
	54, // 12: walletrpc.BumpFeeRequest.outpoint:type_name -> lnrpc.OutPoint
	56, // 13: walletrpc.ListSweepsResponse.transaction_details:type_name -> lnrpc.TransactionDetails
	49, // 14: walletrpc.ListSweepsResponse.transaction_ids:type_name -> walletrpc.ListSweepsResponse.TransactionIDs
	50, // 15: walletrpc.SpendUTXOsRequest.utxos:type_name -> walletrpc.SpendUTXOsRequest.UTXOAndKey
	51, // 16: walletrpc.SpendUTXOsRequest.outputs:type_name -> walletrpc.SpendUTXOsRequest.Output
	...
	54, // 19: walletrpc.TxTemplate.inputs:type_name -> lnrpc.OutPoint
	52, // 20: walletrpc.TxTemplate.outputs:type_name -> walletrpc.TxTemplate.OutputsEntry
	54, // 21: walletrpc.UtxoLease.outpoint:type_name -> lnrpc.OutPoint
	...
	57, // 26: walletrpc.WalletKit.DeriveKey:input_type -> signrpc.KeyLocator
	...
	31, // 37: walletrpc.WalletKit.DeriveNextAccount:input_type -> walletrpc.DeriveNextAccountRequest
	33, // 38: walletrpc.WalletKit.ExportPrivateKey:input_type -> walletrpc.ExportPrivateKeyRequest
	35, // 39: walletrpc.WalletKit.RescanWallet:input_type -> walletrpc.RescanWalletRequest
	37, // 40: walletrpc.WalletKit.SpendUTXOs:input_type -> walletrpc.SpendUTXOsRequest
	39, // 41: walletrpc.WalletKit.GetWalletTx:input_type -> walletrpc.GetWalletTxRequest
	41, // 42: walletrpc.WalletKit.LabelTransaction:input_type -> walletrpc.LabelTransactionRequest
	43, // 43: walletrpc.WalletKit.FundPsbt:input_type -> walletrpc.FundPsbtRequest
	47, // 44: walletrpc.WalletKit.FinalizePsbt:input_type -> walletrpc.FinalizePsbtRequest
	...
	58, // 48: walletrpc.WalletKit.DeriveNextKey:output_type -> signrpc.KeyDescriptor
	58, // 49: walletrpc.WalletKit.DeriveKey:output_type -> signrpc.KeyDescriptor
	...
	32, // 60: walletrpc.WalletKit.DeriveNextAccount:output_type -> walletrpc.DeriveNextAccountResponse
	34, // 61: walletrpc.WalletKit.ExportPrivateKey:output_type -> walletrpc.ExportPrivateKeyResponse
	36, // 62: walletrpc.WalletKit.RescanWallet:output_type -> walletrpc.RescanWalletResponse
	38, // 63: walletrpc.WalletKit.SpendUTXOs:output_type -> walletrpc.SpendUTXOsResponse
	40, // 64: walletrpc.WalletKit.GetWalletTx:output_type -> walletrpc.GetWalletTxResponse
	42, // 65: walletrpc.WalletKit.LabelTransaction:output_type -> walletrpc.LabelTransactionResponse
	44, // 66: walletrpc.WalletKit.FundPsbt:output_type -> walletrpc.FundPsbtResponse
	48, // 67: walletrpc.WalletKit.FinalizePsbt:output_type -> walletrpc.FinalizePsbtResponse
