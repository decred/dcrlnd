...
type HTLCAttemptInfo struct {
	...
	// EC operations used by secp256k1.PrivKeyFromBytes.
	...
	cachedSessionKey *secp256k1.PrivateKey
...
func NewHtlcAttemptInfo(attemptID uint64, sessionKey *secp256k1.PrivateKey,
	...
	var scratch [secp256k1.PrivKeyBytesLen]byte
...
func (h *HTLCAttemptInfo) SessionKey() *secp256k1.PrivateKey {
	if h.cachedSessionKey == nil {
		h.cachedSessionKey = secp256k1.PrivKeyFromBytes(
			h.sessionKey[:],
		)
	}
