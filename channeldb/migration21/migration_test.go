...
var (
	...
	testSig = ecdsa.NewSignature(
		mustDecodeModNScalar("063724406601629180062774974542967536251589935445068131219452686511677818569431"),
		mustDecodeModNScalar("018801056069249825825291287104931333862866033135609736119018462340006816851118"),
	)
